  ...
  useEffect(() => {
    (async () => {
      ...
      if (resp.ok && resp.data) {
        ...
        // Get active child from stored token info
    ...
    <div className="max-w-md mx-auto space-y-6 pb-4">
      ...
      <div className="space-y-2">
        ...
        <button
          ...
          className="w-full flex items-center gap-3 rounded-xl bg-red-50 border border-red-100 p-4 text-sm text-red-600 hover:bg-red-100 transition"
        >
